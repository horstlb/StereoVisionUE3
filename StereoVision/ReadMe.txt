========================================================================
    KONSOLENANWENDUNG: StereoVision-Projektübersicht
========================================================================

Diese StereoVision-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre StereoVision-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "StereoVision.pch und eine 
